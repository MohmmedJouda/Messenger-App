...
<body>
        ...
        <div class="layout overflow-hidden">
            ...
            <nav class="navigation d-flex flex-column text-center navbar navbar-light hide-scrollbar">
                ...
                <ul class="d-flex nav navbar-nav flex-row flex-xl-column flex-grow-1 justify-content-between justify-content-xl-center align-items-center w-100 py-4 py-lg-2 px-lg-3"
                    ...
                    <!-- Chats -->
                    <li class="nav-item">
                        <a class="nav-link active py-0 py-lg-8" id="tab-chats" href="#tab-content-chats"
                            title="Chats" data-bs-toggle="tab" role="tab">
                    ...
                    <div class="text-center py-10">
                        <div class="row gy-6">
                            ...
                            <div class="col-12">
                                ...
                                <p>
                                    Bootstrap is an open source <br />
                                    toolkit for developing web with <br />
                                    HTML, CSS, and JS.
                                </p>
                            </div>
                        </div>
                            ...
                            <div class="row row-cols-3 g-3 py-6">
                                <div class="col">
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#modal-media-preview"
                                        ...
                                        <img class="img-fluid rounded" src="assets/img/chat/1.jpg"
                                            alt="" />
                                    </a>
                                </div>
                                ...
                                <div class="col">
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#modal-media-preview"
                                        ...
                                        <img class="img-fluid rounded" src="assets/img/chat/2.jpg"
                                            alt="" />
                                    </a>
                                </div>
                                ...
                                <div class="col">
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#modal-media-preview"
                                        ...
                                        <img class="img-fluid rounded" src="assets/img/chat/3.jpg"
                                            alt="" />
                                    </a>
                                </div>
                                ...
                                <div class="col">
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#modal-media-preview"
                                        data-theme-img-url="assets/img/chat/media-1.jpg">
                                        <img class="img-fluid rounded" src="assets/img/chat/4.jpg"
                                            alt="" />
                                    </a>
                                </div>
                                ...
                                <div class="col">
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#modal-media-preview"
                                        data-theme-img-url="assets/img/chat/media-2.jpg">
                                        <img class="img-fluid rounded" src="assets/img/chat/5.jpg"
                                            alt="" />
                                    </a>
                                </div>
                                ...
                                <div class="col">
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#modal-media-preview"
                                        data-theme-img-url="assets/img/chat/media-3.jpg">
                                        <img class="img-fluid rounded" src="assets/img/chat/6.jpg"
                                            alt="" />
                                    </a>
                                </div>
                                ...
                                <div class="col">
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#modal-media-preview"
                                        data-theme-img-url="assets/img/chat/media-1.jpg">
                                        <img class="img-fluid rounded" src="assets/img/chat/7.jpg"
                                            alt="" />
                                    </a>
                                </div>
                                ...
                                <div class="col">
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#modal-media-preview"
                                        data-theme-img-url="assets/img/chat/media-2.jpg">
                                        <img class="img-fluid rounded" src="assets/img/chat/8.jpg"
                                            alt="" />
                                    </a>
                                </div>
                                ...
                                <div class="col">
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#modal-media-preview"
                                        data-theme-img-url="assets/img/chat/media-3.jpg">
                                        <img class="img-fluid rounded" src="assets/img/chat/9.jpg"
                                            alt="" />
                                    </a>
                                </div>
                            </div>
                                        ...
                                        <div class="col-auto">
                                            <div class="avatar-group">
                                                <a href="#" class="avatar avatar-sm">
                                                    <img src="assets/img/avatars/2.jpg" class="avatar-img"
                                                        alt="#" />
                                                </a>
            ...
            <div class="modal-dialog modal-dialog-centered modal-fullscreen-xl-down">
                <div class="modal-content">
                    ...
                    <div class="modal-body py-0">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <a href="#tab-settings" class="text-reset" data-theme-toggle="tab"
                                    title="Settings" data-bs-dismiss="modal">Settings</a>
                            </li>
    ...
    <script>
        ...
        var pusher = new Pusher('2d8c5e4623ffbd468514', {
            cluster: 'ap2',
