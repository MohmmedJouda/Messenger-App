<template>
    <div class="chat-body hide-scrollbar flex-1 h-100" id="chat-content" style="margin-bottom: 70px;">
        <div class="chat-body-inner">
            <div class="py-6 py-lg-12" id="chat-body" @click="$root.markAsRead()">
                <div v-for="message in $root.messages" :key="message.id"
                class="message" :class="{'message-out': message.user_id == $root.userId}">
                    ...
                    <div class="message-inner">
                        <div class="message-body">
                            <div class="message-content">
                                ...
                                <div class="message-gallery" v-if="message.type=='attachment' && message.body.mimetype.match(/image\/.+/)">
                                    ...
                                    <div class="row gx-3">
                                        <div class="col">
                                            <img class="img-fluid rounded" :src="'/storage/'+message.body.file_path" data-action="zoom" alt="">
                                        </div>
                                    </div>
                                </div>
                                <div class="message-text" v-if="message.type=='attachment' && !message.body.mimetype.match(/image\/.+/)">
                                    <div class="row align-items-center gx-4">
                                        <div class="col-auto">
                                            <a :href="'/storage/'+message.body.file_path" class="avatar avatar-sm">
                        ...
                        <div class="message-footer">
                            <span class="extra-small text-muted">
                                {{$root.moment(message.created_at).fromNow()}}</span>
                        </div>
                    </div>
                </div>
